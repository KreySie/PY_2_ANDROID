  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      body: Container(
        ...
        decoration: BoxDecoration(color: Colors.red, image: DecorationImage(image: NetworkImage("https://raw.githubusercontent.com/KreySie/MisImagenes/main/Hagaloo.jpg"), alignment: Alignment.topCenter)),
        child: Column(
          children: <Widget>[
            Row(
